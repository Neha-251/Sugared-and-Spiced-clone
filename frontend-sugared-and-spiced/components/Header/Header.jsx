        ...
        <>
            {
                display ? null :
                    ...
                    <div>
                        ...
                        <nav className="flex absolute cursor-pointer top-20 left-10 w-full justify-between z-10">
                            <div className="p-2">
                            ...
                            <div className="flex pt-2 w-1/2 text-white mr-20 justify-evenly cursor-pointer">
                                ...
                                <p className="cursor-pointer  hover:text-teal-100">The Difference (FAQ)</p>
                                ...
                                <p className="cursor-pointer  hover:text-teal-100">Menu</p>
