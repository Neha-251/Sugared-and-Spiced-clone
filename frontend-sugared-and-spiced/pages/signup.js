...
const Signup = () => {
    ...
    return (
        <div className="text-center w-1/2 mx-auto p-5 my-20 ">
            ...
            <div className="my-14">
                <input className="outline-none border-2 border-red-300 my-2 w-2/4 h-10 p-2 text-xl" onChange={(e)=> setUserData(e.target.value)} value={userData.name} type="text" placeholder="Firstname Lastname" /> <br/>
                <input className="outline-none border-2 border-red-300 my-2 w-2/4 h-10 p-2 text-xl" onChange={(e)=> setUserData(e.target.value)} value={userData.email} type="text" placeholder="Email" /><br/>
